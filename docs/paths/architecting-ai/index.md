...
<div class="path-hero">
    ...
    <h1 class="path-title">Architecting AI</h1>
    <p class="path-subtitle">Design scalable AI systems</p>
    <p class="path-description">Learn system design patterns, infrastructure choices, and best practices for building reliable, scalable AI systems. Master the art of architecting production-grade AI solutions.</p>
</div>
...
<div class="path-meta">
    ...
    <div class="meta-card">
        ...
        <ul>
            ...
            <li>Choose optimal infrastructure</li>
