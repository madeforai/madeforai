...
<div class="path-hero">
    ...
    <h1 class="path-title">Researching AI</h1>
    <p class="path-subtitle">Push the boundaries of AI innovation</p>
    <p class="path-description">Explore cutting-edge research, learn to read and implement papers, and contribute to the field. Develop the skills to design novel architectures and conduct rigorous experiments.</p>
</div>
...
<div class="path-meta">
    <div class="meta-card">
        ...
        <ul>
            ...
            <li>Research experience helpful</li>
        </ul>
    </div>
    ...
    <div class="meta-card">
        ...
        <ul>
            <li>Read and implement papers</li>
            <li>Design novel architectures</li>
            <li>Conduct rigorous experiments</li>
            <li>Contribute to open-source research</li>
        </ul>
    </div>
</div>
